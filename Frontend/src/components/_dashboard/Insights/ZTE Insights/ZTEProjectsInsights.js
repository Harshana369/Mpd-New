...
export default function ZTEProjectsInsights() {
  ...
  const fetchProjectNames = async () => {
    try {
      const response = await axiosInstance.get('/filteredZTEProjectsNamesArray');
  ...
  const fetchTilesData = async () => {
    try {
      const response = await axiosInstance.get('/ZTEVendorProjectsDatabases', {
        params: { Project: dropdownValue }
      });
  ...
  const fetchCompletion = async () => {
    try {
      const response = await axiosInstance.get('/ZTEVendorProjectsDatabasesCompletion', {
        params: { Project: dropdownValue }
      });
